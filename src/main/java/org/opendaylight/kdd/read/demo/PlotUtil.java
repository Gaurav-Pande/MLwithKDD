...
public class PlotUtil {
    ...
    /**Plot the testing data. Assume 2d input, classification output
     * @param features testing data features
     * @param labels testing data labels (one-hot representation)
    ...
    private static XYDataset createDataSetTrain(INDArray features, INDArray labels ){
        ...
        //Labels are fetched from Dataset in argMax.data
